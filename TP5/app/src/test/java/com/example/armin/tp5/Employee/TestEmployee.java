...
public class TestEmployee{
    ...
    public void teste() throws Exception {
        ...
        EmployeeFactory emp = new EmployeeFactory("TEA11111", "2314565346", 15000.00, "08H00-13H00", "Armin", "Wentzel", "21/06/1995", "Male", "0764805005", "Teacher");
        ...
        Assert.assertEquals(person.getEmpNr(), "123123123");
    }
}
