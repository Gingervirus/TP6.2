...
public class EmployeeFactory {
    ...
    public EmployeeFactory(String empNr, String sarsNr, double salary, String workingHours, String name, String lastName, String dob, String gender, String cell, String job) {
        this.empNr = empNr;
        this.sarsNr = sarsNr;
        this.salary = salary;
    ...
    public EmployeeData getEmployee()
    {
        ...
        EmployeeData emp = new EmployeeData.Builder()
                .empNr(empNr)
                .salary(Double.parseDouble(SalaryFactory.getSalary(empNr)))
